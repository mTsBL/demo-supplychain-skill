...
def get_week_info():
    ...
    return (
        ...
        today.isocalendar()[1],
        today.year,
        today.strftime("%d/%m/%Y às %H:%M"),
    )


def generate():
    start, end, week, year, timestamp = get_week_info()
...
<div class="header">
    <div>
        ...
        <div class="period">Nexus Commerce &nbsp;·&nbsp; Semana {week} de {year} &nbsp;·&nbsp; {start} a {end}</div>
    </div>
...
<div class="container">
    ...
    <div class="kpis">
        <div class="kpi-card">
            ...
            <div class="kpi-value">R$ 139,5k</div>
            <div class="kpi-delta up">↑ 12,4% vs semana anterior</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Unidades Vendidas</div>
            <div class="kpi-value">1.847</div>
            <div class="kpi-delta up">↑ 8,2% vs semana anterior</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Ticket Médio</div>
            <div class="kpi-value">R$ 75,50</div>
            <div class="kpi-delta down">↓ 3,8% vs semana anterior</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Novos Clientes</div>
            <div class="kpi-value">234</div>
            <div class="kpi-delta up">↑ 21,3% vs semana anterior</div>
        </div>
    </div>
    ...
    <div class="grid-2">
        <div class="card">
            ...
            <div class="chart">
                <div class="bar-row">
                    <div class="bar-label">Headset Pro X1</div>
                    <div class="bar-track"><div class="bar-fill" style="width:82%;background:#4361ee">R$ 45,2k</div></div>
                    <div class="bar-value">452 un.</div>
                </div>
                <div class="bar-row">
                    <div class="bar-label">Webcam 4K Ultra</div>
                    <div class="bar-track"><div class="bar-fill" style="width:61%;background:#7209b7">R$ 33,7k</div></div>
                    <div class="bar-value">337 un.</div>
                </div>
                <div class="bar-row">
                    <div class="bar-label">Suporte Notebook Flex</div>
                    <div class="bar-track"><div class="bar-fill" style="width:52%;background:#3a0ca3">R$ 28,5k</div></div>
                    <div class="bar-value">570 un.</div>
                </div>
                <div class="bar-row">
                    <div class="bar-label">Hub USB 7 Portas</div>
                    <div class="bar-track"><div class="bar-fill" style="width:35%;background:#4cc9f0;color:#1a1a2e">R$ 19,3k</div></div>
                    <div class="bar-value">386 un.</div>
                </div>
                <div class="bar-row">
                    <div class="bar-label">Cabo USB-C Premium</div>
                    <div class="bar-track"><div class="bar-fill" style="width:23%;background:#f72585">R$ 12,8k</div></div>
                    <div class="bar-value">102 un.</div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="chart">
                <div class="bar-row">
                    <div class="bar-label-sm">Sudeste</div>
                    <div class="bar-track"><div class="bar-fill" style="width:74%;background:#4361ee">51%</div></div>
                </div>
                <div class="bar-row">
                    <div class="bar-label-sm">Sul</div>
                    <div class="bar-track"><div class="bar-fill" style="width:35%;background:#7209b7">24%</div></div>
                </div>
                <div class="bar-row">
                    <div class="bar-label-sm">Nordeste</div>
                    <div class="bar-track"><div class="bar-fill" style="width:22%;background:#3a0ca3">15%</div></div>
                </div>
                <div class="bar-row">
                    <div class="bar-label-sm">Norte</div>
                    <div class="bar-track"><div class="bar-fill" style="width:10%;background:#4cc9f0;color:#1a1a2e">7%</div></div>
                </div>
                <div class="bar-row">
                    <div class="bar-label-sm">C. Oeste</div>
                    <div class="bar-track"><div class="bar-fill" style="width:4%;background:#f72585">3%</div></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Receita</th>
                    <th>Ticket Médio</th>
                    <th>vs Sem. Anterior</th>
                    <th>Status</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><strong>Headset Pro X1</strong></td>
                    <td>452</td>
                    <td>R$ 45.200,00</td>
                    <td>R$ 100,00</td>
                    <td class="up">+18,3%</td>
                    <td><span class="status hot">🔥 Alta demanda</span></td>
                </tr>
                <tr>
                    <td><strong>Webcam 4K Ultra</strong></td>
                    <td>337</td>
                    <td>R$ 33.700,00</td>
                    <td>R$ 100,00</td>
                    <td class="up">+7,1%</td>
                ...
                <tr>
                    <td><strong>Suporte Notebook Flex</strong></td>
                    <td>570</td>
                    <td>R$ 28.500,00</td>
                    <td>R$ 50,00</td>
                    <td class="up">+3,2%</td>
                ...
                <tr>
                    <td><strong>Hub USB 7 Portas</strong></td>
                    <td>386</td>
                    <td>R$ 19.300,00</td>
                    <td>R$ 50,00</td>
                    <td class="down">-2,4%</td>
                    <td><span class="status low">⚠ Atenção</span></td>
                </tr>
                <tr>
                    <td><strong>Cabo USB-C Premium</strong></td>
                    <td>102</td>
                    <td>R$ 12.800,00</td>
                    <td>R$ 125,49</td>
...
<div class="footer">
    ...
    path = f"/tmp/weekly-report-{datetime.now().strftime('%Y-%m-%d')}.html"
